...
export default function LaboratoryStaff() {
  ...
  const resetForm = () => {
    ...
    // =====================================
  // ADD OR UPDATE LABORATORY STAFF
  // =====================================
  ...
  const deleteStaff = async (id) => {
    ...
    if (!window.confirm("Delete this laboratory staff?")) {
      return;
    }
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1">
        ...
        <div className="p-8">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-2">
                Manage laboratory staff accounts and login credentials.
              </p>
          ...
          {/* ==========================================
    ADD / EDIT LABORATORY STAFF MODAL
========================================== */}
    ...
    <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl p-8">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <h2 className="text-2xl font-bold">
          {editingId ? "Edit Laboratory Staff" : "Add Laboratory Staff"}
        </h2>
